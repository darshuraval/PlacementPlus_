namespace PlacementPlus_
{
    partial class JdDetails
    {
        ...
        private void InitializeComponent()
        {
			...
			this.txtJobProfile = new System.Windows.Forms.TextBox();
			...
			this.txtDriveDate = new System.Windows.Forms.TextBox();
			this.label13 = new System.Windows.Forms.Label();
			this.txtDriveLocation = new System.Windows.Forms.TextBox();
			...
			this.Logo.Location = new System.Drawing.Point(20, 30);
			this.Logo.Name = "Logo";
			...
			this.pictureBox1.Location = new System.Drawing.Point(1369, 27);
			...
			// txtCompanyName
			// 
			this.txtCompanyName.Location = new System.Drawing.Point(54, 102);
			this.txtCompanyName.Multiline = true;
			this.txtCompanyName.Name = "txtCompanyName";
			this.txtCompanyName.Size = new System.Drawing.Size(289, 39);
			...
			this.label1.Text = "Company Url";
			// 
			// txtCompanyURL
			// 
			this.txtCompanyURL.Location = new System.Drawing.Point(54, 174);
			this.txtCompanyURL.Multiline = true;
			this.txtCompanyURL.Name = "txtCompanyURL";
			this.txtCompanyURL.Size = new System.Drawing.Size(289, 39);
			...
			this.label4.Text = "Job Profile";
			// 
			// txtJobProfile
			// 
			this.txtJobProfile.Location = new System.Drawing.Point(54, 247);
			this.txtJobProfile.Multiline = true;
			this.txtJobProfile.Name = "txtJobProfile";
			this.txtJobProfile.Size = new System.Drawing.Size(289, 39);
			this.txtJobProfile.TabIndex = 9;
			// 
			// label6
			// 
			this.label6.AutoSize = true;
			this.label6.Font = new System.Drawing.Font("Arial Narrow", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label6.Location = new System.Drawing.Point(50, 452);
			...
			// txtStipend
			// 
			this.txtStipend.Location = new System.Drawing.Point(54, 485);
			this.txtStipend.Multiline = true;
			this.txtStipend.Name = "txtStipend";
			this.txtStipend.Size = new System.Drawing.Size(289, 39);
			this.txtStipend.TabIndex = 13;
			// 
			// label7
			// 
			this.label7.AutoSize = true;
			this.label7.Font = new System.Drawing.Font("Arial Narrow", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label7.Location = new System.Drawing.Point(361, 75);
			this.label7.Name = "label7";
			this.label7.Size = new System.Drawing.Size(102, 24);
			this.label7.TabIndex = 14;
			this.label7.Text = "Job Location";
			// 
			// txtJobLocation
			// 
			this.txtJobLocation.Location = new System.Drawing.Point(365, 102);
			this.txtJobLocation.Multiline = true;
			this.txtJobLocation.Name = "txtJobLocation";
			this.txtJobLocation.Size = new System.Drawing.Size(289, 39);
			this.txtJobLocation.TabIndex = 15;
			// 
			// label8
			// 
			...
			// txtBatch
			// 
			this.txtBatch.Location = new System.Drawing.Point(365, 177);
			this.txtBatch.Multiline = true;
			this.txtBatch.Name = "txtBatch";
			this.txtBatch.Size = new System.Drawing.Size(289, 39);
			this.txtBatch.TabIndex = 17;
			// 
			// label16
			// 
			...
			this.label16.Location = new System.Drawing.Point(732, 41);
			this.label16.Name = "label16";
			this.label16.Size = new System.Drawing.Size(296, 37);
			this.label16.TabIndex = 18;
			this.label16.Text = "Schedule and Coordi...";
			// 
			// label15
			// 
			...
			this.label15.Text = "Drive Date";
			// 
			// txtDriveDate
			// 
			this.txtDriveDate.Location = new System.Drawing.Point(739, 121);
			this.txtDriveDate.Multiline = true;
			this.txtDriveDate.Name = "txtDriveDate";
			this.txtDriveDate.Size = new System.Drawing.Size(289, 39);
			this.txtDriveDate.TabIndex = 20;
			// 
			// label13
			// 
			...
			this.label13.Location = new System.Drawing.Point(735, 174);
			this.label13.Name = "label13";
			this.label13.Size = new System.Drawing.Size(114, 24);
			this.label13.TabIndex = 23;
			this.label13.Text = "Drive Location";
			// 
			// txtDriveLocation
			// 
			this.txtDriveLocation.Location = new System.Drawing.Point(739, 201);
			this.txtDriveLocation.Multiline = true;
			this.txtDriveLocation.Name = "txtDriveLocation";
			this.txtDriveLocation.Size = new System.Drawing.Size(289, 39);
			this.txtDriveLocation.TabIndex = 24;
			// 
			// label9
			// 
			...
			this.label9.Text = "CTC";
			// 
			// txtCTC
			// 
			this.txtCTC.Location = new System.Drawing.Point(54, 323);
			this.txtCTC.Multiline = true;
			this.txtCTC.Name = "txtCTC";
			this.txtCTC.Size = new System.Drawing.Size(289, 39);
			this.txtCTC.TabIndex = 32;
			// 
			// label23
			// 
			...
			this.label23.Location = new System.Drawing.Point(732, 320);
			this.label23.Name = "label23";
			this.label23.Size = new System.Drawing.Size(236, 37);
			this.label23.TabIndex = 33;
			this.label23.Text = "Company Contact";
			// 
			// label22
			// 
			...
			this.label22.Location = new System.Drawing.Point(735, 373);
			this.label22.Name = "label22";
			this.label22.Size = new System.Drawing.Size(111, 24);
			this.label22.TabIndex = 34;
			this.label22.Text = "Person Name";
			// 
			// txtPersonName
			// 
			this.txtPersonName.Location = new System.Drawing.Point(739, 400);
			this.txtPersonName.Multiline = true;
			this.txtPersonName.Name = "txtPersonName";
			this.txtPersonName.Size = new System.Drawing.Size(289, 39);
			...
			this.label17.Location = new System.Drawing.Point(1064, 373);
			this.label17.Name = "label17";
			this.label17.Size = new System.Drawing.Size(212, 24);
			this.label17.TabIndex = 44;
			this.label17.Text = "Person Phone/Mobile/Email";
			// 
			// txtPersonMobile
			// 
			this.txtPersonMobile.Location = new System.Drawing.Point(1068, 400);
			this.txtPersonMobile.Multiline = true;
			this.txtPersonMobile.Name = "txtPersonMobile";
			this.txtPersonMobile.Size = new System.Drawing.Size(289, 39);
			this.txtPersonMobile.TabIndex = 45;
			// 
			// btnSave
			// 
			...
			this.btnSave.Location = new System.Drawing.Point(941, 567);
			...
			this.button2.Location = new System.Drawing.Point(1136, 567);
			...
			this.panel2.Controls.Add(this.txtInternship);
			this.panel2.Controls.Add(this.label10);
			this.panel2.Controls.Add(this.button2);
			this.panel2.Controls.Add(this.btnSave);
			this.panel2.Controls.Add(this.txtPersonMobile);
			this.panel2.Controls.Add(this.label17);
			this.panel2.Controls.Add(this.txtPersonName);
			this.panel2.Controls.Add(this.label22);
			this.panel2.Controls.Add(this.label23);
			this.panel2.Controls.Add(this.txtCTC);
			this.panel2.Controls.Add(this.label9);
			this.panel2.Controls.Add(this.txtDriveLocation);
			this.panel2.Controls.Add(this.label13);
			this.panel2.Controls.Add(this.txtDriveDate);
			this.panel2.Controls.Add(this.label15);
			this.panel2.Controls.Add(this.label16);
			this.panel2.Controls.Add(this.txtBatch);
			this.panel2.Controls.Add(this.label8);
			this.panel2.Controls.Add(this.txtJobLocation);
			this.panel2.Controls.Add(this.label7);
			this.panel2.Controls.Add(this.txtStipend);
			this.panel2.Controls.Add(this.label6);
			this.panel2.Controls.Add(this.txtJobProfile);
			this.panel2.Controls.Add(this.label4);
			this.panel2.Controls.Add(this.txtCompanyURL);
			...
			this.label12.Location = new System.Drawing.Point(1064, 94);
			...
			// txtBranch
			// 
			this.txtBranch.Location = new System.Drawing.Point(365, 264);
			this.txtBranch.Multiline = true;
			this.txtBranch.Name = "txtBranch";
			this.txtBranch.Size = new System.Drawing.Size(289, 39);
			this.txtBranch.TabIndex = 50;
			// 
			// label11
			// 
			...
			this.lblJobId.Text = "NULL";
			// 
			// txtInternship
			// 
			this.txtInternship.Location = new System.Drawing.Point(54, 400);
			this.txtInternship.Multiline = true;
			this.txtInternship.Name = "txtInternship";
			this.txtInternship.Size = new System.Drawing.Size(289, 39);
			this.txtInternship.TabIndex = 47;
			// 
			// label10
			// 
			...
			this.Name = "JdDetails";
			this.Text = "JdDetails";
			this.Load += new System.EventHandler(this.JdDetails_Load);
		...
		private System.Windows.Forms.TextBox txtJobProfile;
		...
		private System.Windows.Forms.TextBox txtDriveDate;
		private System.Windows.Forms.Label label13;
		private System.Windows.Forms.TextBox txtDriveLocation;
		...
		private System.Windows.Forms.TextBox txtInternship;
